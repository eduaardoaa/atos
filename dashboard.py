...
def grafico_linhas_por_filial(mes_referencia, filial_selecionada):
    ...
    # Mapeamento de meses com tratamento para nomes em português e inglês
    meses_map = {
        'Janeiro': 1, 'Fevereiro': 2, 'Março': 3, 'Marco': 3, 'March': 3,
        'Abril': 4, 'Maio': 5, 'May': 5,
        'Junho': 6, 'June': 6,
        'Julho': 7, 'July': 7,
        'Agosto': 8, 'August': 8,
    ...
    # Normalizar nome do mês (remover acentos e converter para chave do dicionário)
